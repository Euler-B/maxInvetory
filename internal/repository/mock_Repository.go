...
import (
	...
	entity "github.com/euler-b/maxInventoryProject/internal/entity"
...
// GetUserByRoles provides a mock function with given fields: ctx, userID
func (_m *MockRepository) GetUserByRoles(ctx context.Context, userID int64) ([]entity.USER_ROLE, error) {
	ret := _m.Called(ctx, userID)

	if len(ret) == 0 {
		panic("no return value specified for GetUserByRoles")
	}

	var r0 []entity.USER_ROLE
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) ([]entity.USER_ROLE, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) []entity.USER_ROLE); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]entity.USER_ROLE)
		}
	}
